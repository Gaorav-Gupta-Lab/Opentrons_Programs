...
def get_values(*names):
    import json
    _all_values = json.loads("""{"pip_model":"p10_single","pip_mount":"left","dp_type":"stacked_96_well","dye_type":"opentrons_24_tuberack_eppendorf_1.5ml_safelock_snapcap"}""")
...
metadata = {
    ...
    'description': 'Test protocol to make the Opentrons logo in a 96 well plate',
    'apiLevel': '2.7'
    }
...
def run(protocol: protocol_api.ProtocolContext):
    ...
    # protocol.load_instrument('p10_single', 'left')
    ...
    dye1 = dye_container['A3']

    dye_vol = 100 if tip_size == '1000' else 9
